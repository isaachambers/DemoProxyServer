package com.isaachambers.demo.filters;
 ...
 * @author isaack
 * 
 *         All Zuul filters must extend the ZuulFilter class and override four
 *         methods: filterType(), filterOrder(), shouldFilter(), and run().
 */
